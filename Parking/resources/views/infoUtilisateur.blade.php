    ...
    <table class="text-left w-full border-collapse">
        ...
        <tbody>
          ...
          <tr class="hover:bg-grey-lighter">
              ...
              <td class="py-4 px-6 border-b border-grey-light"> <a href="/dd?id_u=@php echo$lien;@endphp" class="text-grey-lighter font-bold py-1 px-3 rounded bg-green hover:bg-green-dark">Modifier</a></td>
